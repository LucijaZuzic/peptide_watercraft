...
\begin{table}[!ht]
	...
	\label{tab:wilcoxon_speed_actual_dir_MAE}
\end{table}
...
\begin{table}[!ht]
	...
	\label{tab:wilcoxon_speed_actual_dir_R2}
\end{table}
...
\begin{table}[!ht]
	...
	\label{tab:wilcoxon_speed_actual_dir_euclid}
\end{table}
...
\begin{table}[!ht]
	...
	\label{tab:wilcoxon_speed_actual_dir_haversine}
\end{table}